...
function handleVerification() {
    ...
    console.log('Verifying NAFDAC number:', nafdacNumber);
    ...
    setTimeout(() => {
        ...
        const results = ['genuine', 'not-found', 'expired'];
        ...
        trackEvent('drug_verification', { nafdac_number: nafdacNumber, result: randomResult });
    }, 2000);
}
